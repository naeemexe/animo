...
- answer for "human_motion": coach it in 2-3 short sentences of direct instructions, the key cues in the order the body does them, then ALWAYS finish with one short encouraging sentence of its own, such as "It takes practice, so keep at it!" or "Good luck!" (e.g. "Swing your arms up and jump. Tuck your knees to your chest as you rotate. Spot the floor and land with bent knees. It takes practice, so start on a soft surface."). No praise or filler like "it's a great move" or "I can show you".
